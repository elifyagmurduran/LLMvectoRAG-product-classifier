...
class AzureOpenAILLMProvider(LLMProvider):
    ...
    Args:
        ...
        rpm_limit: Requests per minute (0 = unlimited).
        tpm_limit: Tokens per minute (0 = unlimited).
    """
    ...
    def __init__(self, api_key: str, endpoint: str, deployment: str,
                 ...
                 rpm_limit: int = 0, tpm_limit: int = 0,
                 **kwargs):
        self._deployment = deployment
        self._model = model
        self._max_completion_tokens = max_completion_tokens
        self._rate_limiter = RateLimiter(rpm_limit=rpm_limit, tpm_limit=tpm_limit)
        ...
        if rpm_limit or tpm_limit:
            logger.info("Rate limiter active — RPM: %s, TPM: %s",
                        rpm_limit or "unlimited", tpm_limit or "unlimited")
